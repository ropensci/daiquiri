...
```{r sourcedata}
sourcesummary <- summarise_source_data(params$sourcedata, show_progress = FALSE)
...
reactable::reactable(
  ...
  sourcedatafields[which(trimws(sourcesummary$datafields$field_type) != "ignore"), ],
  sortable = TRUE,
  filterable = FALSE,
  searchable = FALSE,
  rownames = FALSE,
...
reactable::reactable(
  # NOTE: trimws() needed as summarise_source_data() is optimised for console printout
  sourcedatafields[
    which(trimws(sourcesummary$datafields$field_type) == "ignore"),
    c("fieldname", "field_type", "ordinal_position")
  ],
  sortable = TRUE,
  filterable = FALSE,
  searchable = FALSE,
