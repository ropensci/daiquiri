...
```{r source_data}
sourcesummary <- summarise_source_data(params$source_data, show_progress = FALSE)
...
reactable::reactable(
  ...
  source_data_fields[which(trimws(sourcesummary$data_fields$field_type) != "ignore"), ],
  sortable = TRUE,
  filterable = FALSE,
  searchable = FALSE,
  rownames = FALSE,
