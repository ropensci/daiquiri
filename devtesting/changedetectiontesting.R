...
#logname <- log_newfilename(".\\devtesting\\testoutput")
log_initialise(".\\devtesting\\testoutput")
#log_openconnection(".\\devtesting\\testoutput")
#log_closeconnection()
...
#																																		,DoseUnit = ft_ignore()
																																		,FirstAdministrationDateTime = ft_datetime()
																																		,Clusterid = ft_uniqueidentifier()
																																		,AntibioticsSource = ft_source()), na=c("","NULL"))
...
testcpdsourcedata <- load_dataset(".\\devtesting\\testdata\\abx2014.csv", fieldtypes = fieldtypes(PrescriptionID = ft_ignore()
																																		,TimepointDate = ft_timepoint()
																																		,PrescriptionDate = ft_ignore()
																																		,PrescriptionType = ft_source()
																																		,AdmissionDate = ft_ignore()
																																		,Drug = ft_categorical()
																																		,Formulation = ft_ignore()
																																		,Dose = ft_number()
																																		,DoseUnit = ft_ignore()
