...
The `abx2014` dataset is provided with this package as a csv file, and contains examples of antibiotic prescriptions given in a hospital over a period of a year, with one row per prescription. It contains 8 columns:
...
filename <- system.file("extdata", "abx2014.csv", package = "daiquiri")
...
daiqobj <- create_report(
  ...
  na = c("","NULL"),
  dataset_shortdesc = "abx2014 example data",
...
# clean up
file.remove("./abx2014report.html")
