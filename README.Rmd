...
The intention is to make daiquiri available in CRAN but until then, you can install the current development version from the [r-universe](https://r-universe.dev/):
...
An [example report](https://ropensci.github.io/daiquiri/misc/example_prescriptions_report.html) is available from the [package website](https://ropensci.github.io/daiquiri/index.html).
